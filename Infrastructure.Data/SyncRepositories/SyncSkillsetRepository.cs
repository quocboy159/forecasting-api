...
{
    public class SyncSkillsetRepository : SyncGenericAsyncRepository<Skillset>, ISyncSkillsetRepository
    {
        public SyncSkillsetRepository(SyncForecastingSystemDbContext dbContext) : base(dbContext)
        {
            /*
