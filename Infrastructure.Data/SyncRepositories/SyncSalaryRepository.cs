...
{
    public class SyncSalaryRepository : SyncGenericAsyncRepository<Salary>, ISyncSalaryRepository
    {
        public SyncSalaryRepository(SyncForecastingSystemDbContext dbContext) : base(dbContext)
        {
            /*
