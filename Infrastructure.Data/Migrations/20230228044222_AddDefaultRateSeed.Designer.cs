...
namespace ForecastingSystem.Infrastructure.Data.Migrations
{
    ...
    [Migration("20230228044222_AddDefaultRateSeed")]
    partial class AddDefaultRateSeed
    {
            ...
            modelBuilder.Entity("ForecastingSystem.Domain.Models.Rate", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            HourlyRate = 195m,
                            IsActive = true,
                            RateName = "NZ Project Manager",
                            UpdatedDateTime = new DateTime(2023, 2, 28, 4, 42, 21, 788, DateTimeKind.Utc).AddTicks(870)
                        },
                        new
                        {
                            RateId = 2,
                            HourlyRate = 195m,
                            IsActive = true,
                            RateName = "NZ Architect",
                            UpdatedDateTime = new DateTime(2023, 2, 28, 4, 42, 21, 788, DateTimeKind.Utc).AddTicks(877)
                        },
                        new
                        {
                            RateId = 3,
                            HourlyRate = 170m,
                            IsActive = true,
                            RateName = "NZ Tech Lead",
                            UpdatedDateTime = new DateTime(2023, 2, 28, 4, 42, 21, 788, DateTimeKind.Utc).AddTicks(879)
                        },
                        new
                        {
                            RateId = 4,
                            HourlyRate = 165m,
                            IsActive = true,
                            RateName = "NZ Developer",
                            UpdatedDateTime = new DateTime(2023, 2, 28, 4, 42, 21, 788, DateTimeKind.Utc).AddTicks(881)
                        },
                        new
                        {
                            RateId = 5,
                            HourlyRate = 165m,
                            IsActive = true,
                            RateName = "NZ Business Analyst",
                            UpdatedDateTime = new DateTime(2023, 2, 28, 4, 42, 21, 788, DateTimeKind.Utc).AddTicks(883)
                        },
                        new
                        {
                            RateId = 6,
                            HourlyRate = 85m,
                            IsActive = true,
                            RateName = "VN Developer",
                            UpdatedDateTime = new DateTime(2023, 2, 28, 4, 42, 21, 788, DateTimeKind.Utc).AddTicks(885)
                        },
                        new
                        {
                            RateId = 7,
                            ...
                            IsActive = true,
                            RateName = "VN Tester",
                            UpdatedDateTime = new DateTime(2023, 2, 28, 4, 42, 21, 788, DateTimeKind.Utc).AddTicks(887)
                        },
                        new
                        {
                            RateId = 8,
                            HourlyRate = 90m,
                            IsActive = true,
                            RateName = "VN Tech Lead",
                            UpdatedDateTime = new DateTime(2023, 2, 28, 4, 42, 21, 788, DateTimeKind.Utc).AddTicks(889)
                        });
                });
