...
namespace ForecastingSystem.Infrastructure.Data.Migrations
{
    ...
    [Migration("20230425034532_OptimizePhaseResourceUtilisation")]
    partial class OptimizePhaseResourceUtilisation
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ForecastingSystem.Domain.Models.Employee", b =>
                {
                    ...
                    b.Property<string>("WorkingWeeks")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("ForecastingSystem.Domain.Models.EmployeeTimesheetEntry", b =>
                {
                    b.Property<int>("EmployeeTimesheetEntryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("EmployeeTimesheetEntryId"), 1L, 1);
                    ...
                    b.Property<int?>("ExternalRateId")
                        .HasColumnType("int");

                    b.Property<int>("ExternalTimesheetId")
                        .HasColumnType("int");
                    ...
                    b.Property<string>("TimesheetUsername")
                        .IsRequired()
                        .HasMaxLength(255)
                        .HasColumnType("nvarchar(255)");

                    b.HasKey("EmployeeTimesheetEntryId");

                    b.ToTable("EmployeeTimesheetEntry", (string)null);
                });

            modelBuilder.Entity("ForecastingSystem.Domain.Models.EmployeeUtilisationNotes", b =>
                {
                    b.Property<int>("EmployeeUtilisationNotesId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("EmployeeUtilisationNotesId"), 1L, 1);
                    ...
                    b.Property<string>("InternalWorkNotes")
                        .IsUnicode(false)
                        .HasColumnType("varchar(max)");
                    ...
                    b.HasKey("EmployeeUtilisationNotesId");

                    b.HasIndex("EmployeeId")
                        .IsUnique();

                    b.ToTable("EmployeeUtilisationNotes", (string)null);
                });
            ...
            modelBuilder.Entity("ForecastingSystem.Domain.Models.PhaseResourceUtilisationByWeek", b =>
                {
                    b.Property<int>("PhaseResourceUtilisationByWeekId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("PhaseResourceUtilisationByWeekId"), 1L, 1);
                    ...
                    b.HasKey("PhaseResourceUtilisationByWeekId");

                    b.HasIndex("PhaseResourceUtilisationId");

                    b.ToTable("PhaseResourceUtilisationByWeek", (string)null);
                });
            ...
            modelBuilder.Entity("ForecastingSystem.Domain.Models.PublicHoliday", b =>
                {
                    ...
                    b.Property<int?>("ExternalLeaveHolidayId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ForecastingSystem.Domain.Models.ResourceUtilisationNote", b =>
                {
                    b.Property<int>("ResourceUtilisationNoteId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ResourceUtilisationNoteId"), 1L, 1);
                    ...
                    b.HasKey("ResourceUtilisationNoteId");

                    b.ToTable("ResourceUtilisationNote", (string)null);
                });
            ...
            modelBuilder.Entity("ForecastingSystem.Domain.Models.UserIdLookup", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("BambooHREmail")
                        .HasMaxLength(255)
                        .IsUnicode(false)
                        .HasColumnType("varchar(255)");

                    b.Property<string>("BambooHRFirstName")
                        .HasMaxLength(255)
                        .IsUnicode(false)
                        .HasColumnType("varchar(255)");

                    b.Property<string>("BambooHRLastName")
                        .HasMaxLength(255)
                        .IsUnicode(false)
                        .HasColumnType("varchar(255)");
                    ...
                    b.ToTable("UserIdLookup", (string)null);
                });

            modelBuilder.Entity("ForecastingSystem.Infrastructure.Data.Context.AuditEntry", b =>
                {
                    b.Property<long>("AuditEntryId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<long>("AuditEntryId"), 1L, 1);
            ...
            modelBuilder.Entity("ForecastingSystem.Domain.Models.EmployeeUtilisationNotes", b =>
                {
                    b.HasOne("ForecastingSystem.Domain.Models.Employee", "Employee")
                        .WithOne("EmployeeUtilisationNotes")
                        .HasForeignKey("ForecastingSystem.Domain.Models.EmployeeUtilisationNotes", "EmployeeId")
            ...
            modelBuilder.Entity("ForecastingSystem.Domain.Models.PhaseResourceUtilisation", b =>
                {
                    b.HasOne("ForecastingSystem.Domain.Models.PhaseResource", "PhaseResource")
                        .WithMany("PhaseResourceUtilisations")
                        .HasForeignKey("PhaseResourceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ForecastingSystem.Domain.Models.PhaseResourceUtilisationByWeek", b =>
                {
                    b.HasOne("ForecastingSystem.Domain.Models.PhaseResourceUtilisation", "PhaseResourceUtilisation")
                        .WithMany()
                        .HasForeignKey("PhaseResourceUtilisationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ForecastingSystem.Domain.Models.Employee", b =>
                {
                    ...
                    b.Navigation("EmployeeUtilisationNotes");
            ...
            modelBuilder.Entity("ForecastingSystem.Domain.Models.PhaseResource", b =>
                {
                    ...
                    b.Navigation("PhaseResourceUtilisations");
